...
export function AnimatedAIChat({ defaultModel = availableModels[0], apiKey }: AnimatedAIChatProps = {}) {
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden">
            ...
            <div className="w-full max-w-2xl mx-auto relative">
                ...
                >
                    ...
                    {aiResponse && (
                        <motion.div
                            className="backdrop-blur-2xl bg-white/[0.03] rounded-2xl border border-white/[0.05] shadow-2xl p-6"
                            initial={{ opacity: 0, y: 10 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        >
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <div className="text-sm font-medium text-white/80">AI Assistant</div>
                            </div>
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="text-center text-sm text-white/60 mb-1">Select Model</div>
                        <div className="flex flex-wrap items-center justify-center gap-2">
                            {availableModels.map((model, index) => (
                                <motion.button
                                    ...
                                    className={cn(
                                        "flex items-center gap-2 px-3 py-2 rounded-lg text-sm transition-all relative",
                                        selectedModel === model 
                                            ? "bg-white/[0.08] text-white border border-white/10" 
                                            : "bg-white/[0.02] hover:bg-white/[0.05] text-white/60 hover:text-white/90 border border-transparent"
                                    )}
                                    initial={{ opacity: 0, y: 10 }}
                                    animate={{ opacity: 1, y: 0 }}
